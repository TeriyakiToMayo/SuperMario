...
{
    class HorseRightState : IEnemyState
    {
        public ISprite StateSprite { get; set; }
        private Horse horse;
        public HorseRightState(Horse h)
        {
            StateSprite = EnemySpriteFactory.Instance.CreateHorseRightSprite();
            horse = h;
        }
        ...
        {
            horse.State = new HorseLeftState(horse);
        }
    }
}
