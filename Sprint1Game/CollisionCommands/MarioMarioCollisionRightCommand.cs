...
{
    public class MarioMarioCollisionRightCommand : ICollisionCommand
    {
        public MarioMarioCollisionRightCommand()
        {
        ...
        public void Execute(IGameObject gameObject1, IGameObject gameObject2)
        {
            ...
            {
                mario.Location = new Vector2(mario2.Destination.X + mario2.Destination.Width + 1, mario.Destination.Y);
                mario.Velocity = new Vector2(GameUtilities.StationaryVelocity, mario.Velocity.Y);
            }

            if (mario2.Velocity.X > 0)
            {
                mario2.Location = new Vector2(mario.Destination.X - mario2.Destination.Width - 1, mario2.Destination.Y);
