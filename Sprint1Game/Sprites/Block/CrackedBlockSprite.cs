...
{
    class CrackedBlockSprite : ISprite
    {
        public Texture2D Texture { get; set; }
        private int width;
        private int height;
        public CrackedBlockSprite(Texture2D texture)
        {
            Texture = texture;
        ...
        {          
            int row = BlockSpriteFactory.StageOneSpriteCrackedBlock1Row;
            int column = BlockSpriteFactory.StageOneSpriteCrackedBlock1Column;
